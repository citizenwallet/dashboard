    ...
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new community by selecting a blockchain and providing basic
            information.
          </DialogDescription>
        </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormDescription>
                    Alias must contain only lowercase letters, numbers, and
                    hyphens. It will be used in your community URL.
                  </FormDescription>
                  <FormMessage />
                </FormItem>
              )}
